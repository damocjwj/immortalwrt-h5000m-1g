...
# H5000M 1G is a release-only, single-device build.  Keep the complete vendor
# Filogic fragment intact and apply its no-debug policy only as the final
# configuration layer for this device.
ifneq ($(CONFIG_TARGET_mediatek_filogic_DEVICE_hiveton-h5000m-1g),)
  LINUX_KCONFIG_LIST += $(TOPDIR)/config/h5000m-kernel-6.6.config
endif
